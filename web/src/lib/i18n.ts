...
const en = {
  ...
  noAccount: "New here?", signIn: "Sign in",
  welcome: "Welcome! I'm MyAi", thinking: "thinking…", typeMessage: "Type a message…",
  language: "Language", voice2: "Voice", speed: "Speed", pitch: "Pitch", browserVoice: "Browser voice",
...
const bn: Dict = {
  ...
  noAccount: "নতুন?", signIn: "লগইন",
  welcome: "নমস্কার! আমি MyAi", thinking: "ভাবছি…", typeMessage: "কিছু লিখো…",
  language: "ভাষা", voice2: "ভয়েস", speed: "স্পিড", pitch: "পিচ", browserVoice: "ব্রাউজার ভয়েস",
